...
test <- read.table(file="../Semana 05/cpat_features/Amborella_trichopoda.lncRNA.dat",sep="\t",col.names=c("ID","mRNA","ORF","Fickett","Hexamer"))
...
write.table(output,file="../Semana 05/cpat_features/Amborella_trichopoda.lncRNA",quote=F,sep="\t",row.names=ID)
